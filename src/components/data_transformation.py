...
from sklearn.compose import ColumnTransformer # for column wise operations
...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            logging.info("Data Trnasformation pipeline setupped")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Preprocess object saved and Data Transformation is completed.")
            return (
                train_arr,
                test_arr,
